    ...
    if SAKERA != 159403:
        ...
        try:
            ...
            if len(na) < 2:
                ...
                else:listpass.append(nd);listpass.append(nd+"123");listpass.append(nd+"12");listpass.append(nd+"1");listpass.append(nd+"1234");listpass.append(nd+"786");listpass.append(nd+"12345")
                nb = na[-1].lower()
                if len(nb)<3:pass
                elif len(nb)==3 or len(nb)==4 or len(nb)==5:listpass.append(nb+"123");listpass.append(nb+"12345")
                else:listpass.append(nb);listpass.append(nb+"123");listpass.append(nd+"12");listpass.append(nd+"1");listpass.append(nd+"1234");listpass.append(nd+"786");listpass.append(nb+"12345")
                if pp in ['',' ','  ']:pass
                else:
